...
void PutUnitSpriteIconsOam(void)
{
    ...
    s8 displayIcons = (GetGameClock() % 32) / 11; //gives 0, 1, 2
    ...
    for (i = 1; i < 0xc0; i++)
    {
        ...
        switch (unit->statusIndex) {
			...
			//	CallARM_PushToSecondaryOAM(OAM1_X(0x200+x - 2), OAM0_Y(0x100+y - 4), sPoisonIconSprites[poisonIconFrame], 0);
				CallARM_PushToSecondaryOAM(OAM1_X(0x200+x + displayRescueIcon), OAM0_Y(0x100+y-2), gObject_8x8, 0x864);
				break;

			case UNIT_STATUS_SLEEP:
			//	CallARM_PushToSecondaryOAM(OAM1_X(0x200+x + 2), OAM0_Y(0x100+y), sSleepIconSprites[sleepIconFrame], 0);
				CallARM_PushToSecondaryOAM(OAM1_X(0x200+x + displayRescueIcon), OAM0_Y(0x100+y-2), gObject_8x8, 0x869);
				break;

			case UNIT_STATUS_BERSERK:
			//	CallARM_PushToSecondaryOAM(OAM1_X(0x200+x + 1), OAM0_Y(0x100+y - 5), sBerserkIconSprites[berserkIconFrame], 0);
				CallARM_PushToSecondaryOAM(OAM1_X(0x200+x + displayRescueIcon), OAM0_Y(0x100+y-2), gObject_8x8, 0x823);
				break;
		...
		else if (unitHasAura(unit) && displayRescueIcon) {

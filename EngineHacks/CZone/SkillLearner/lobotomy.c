...
u16 const gSprite_SupportScreenSuccessBox[] = {
    6,
...
u16 const gSprite_SupportScreenBanner[] = {
    3,
...
struct ProcCmd const gProcScr_SupportScreen_DrawBannerSprites[] = {
    PROC_SLEEP(0),
...
struct ProcCmd const gProcScr_SupportScreen[] = {
    PROC_SLEEP(0),
...
u16 const sSprite_08A19850[] = {
    2,
    0x4000, 0x8000, 0x0800,
    0x0000, 0x4020, 0x0804,
};

u16 const sSprite_08A1985E[] = {
    3,
...
struct ProcCmd const gProcScr_SupportUnitSubScreen[] = {
    PROC_SLEEP(0),

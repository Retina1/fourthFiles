...
void LevelUpSkill(struct Unit* unit, u8 skill) {
	...
	//2 pters
		...
		if (unit->skills.skill_352 == 1) {
			unit->skills.skill_353 = 1;
		}
		else if (unit->skills.skill_351 == 1) {
			unit->skills.skill_352 = 1;
		}
		else {
			unit->skills.skill_351 = 1;
		}
		return;
	}
    else if (skill == 12) {
		...
		if (unit->skills.skill_534 == 1) {
			unit->skills.skill_535 = 1;
		}
		else if (unit->skills.skill_533 == 1) {
			unit->skills.skill_534 = 1;
		}
		else if (unit->skills.skill_532 == 1) {
			unit->skills.skill_533 = 1;
		}
		else if (unit->skills.skill_531 == 1) {
			unit->skills.skill_532 = 1;
		}
		else {
			unit->skills.skill_531 = 1;
		}
		return;
	//stat passives
	}
...
u8 GetSkillLevel(struct Unit* unit, u8 skill) {
	...
	//2 pters
		...
		level = unit->skills.skill_351 + unit->skills.skill_352 + unit->skills.skill_353;
	}
    else if (skill == 12) {
		...
		level = unit->skills.skill_531 + unit->skills.skill_532 + unit->skills.skill_533 + unit->skills.skill_534 + unit->skills.skill_535;
	}
	//statboosts
    else if (skill == 15) {
...
int GetUnitSpentSP(struct Unit* unit){
	int total = 0;
	// 1 pointers
	total += unit->skills.skill_111 + unit->skills.skill_121 + unit->skills.skill_131 + unit->skills.skill_141;
	// 2 pointers
	...
	// 3 pointers
	total += unit->skills.skill_311 + unit->skills.skill_312 + unit->skills.skill_313 + unit->skills.skill_321 + unit->skills.skill_322 + unit->skills.skill_323 + unit->skills.skill_331 + unit->skills.skill_332 + unit->skills.skill_333 + unit->skills.skill_341 + unit->skills.skill_342 + unit->skills.skill_343 + unit->skills.skill_351 + unit->skills.skill_352 + unit->skills.skill_353;
	// 5 pointers
	total += unit->skills.skill_511 + unit->skills.skill_512 + unit->skills.skill_513 + unit->skills.skill_514 + unit->skills.skill_515 + unit->skills.skill_521 + unit->skills.skill_522 + unit->skills.skill_523 + unit->skills.skill_524 + unit->skills.skill_525 + unit->skills.skill_531 + unit->skills.skill_532 + unit->skills.skill_533 + unit->skills.skill_534 + unit->skills.skill_535;
	// stat passives

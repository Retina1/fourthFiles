...
enum
{
    ...
    US_BIT19        = (1 << 19),//??
    US_BIT20        = (1 << 20),
    US_BIT21        = (1 << 21),//not deploted
    US_BIT22        = (1 << 22),//cutscene
    US_BIT23        = (1 << 23),//portrait index+
    // = (1 << 24),//shake
    US_BIT25 = (1 << 25),//fe7 unvailable
    US_BIT26 = (1 << 26),//remu
    US_BIT27 = (1 << 27),//alt pal
    US_BIT_ALREADY_REFRESHED = (1 << 28),
    // = (1 << 29),
    // = (1 << 30),
    // = (1 << 31),

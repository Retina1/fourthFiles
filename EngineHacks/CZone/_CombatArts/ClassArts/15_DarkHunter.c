...
int WhipstormOdds(struct BattleUnit* actor, struct BattleUnit* target){
	int odds = 20;
	if (UNIT_HAS_SKILL(&actor->unit,DOM,skill_525)){
		odds = 40;
	}
	else if (UNIT_HAS_SKILL(&actor->unit,DOM,skill_523)){
		odds = 30;
	}
	return odds;
}
...
int MirageWhipOdds(struct BattleUnit* actor, struct BattleUnit* target){
	int odds = 20;
	if (UNIT_HAS_SKILL(&actor->unit,DOM,skill_333)){
		odds = 60;
	}
	if (UNIT_HAS_SKILL(&actor->unit,DOM,skill_332)){
		odds = 40;
	}
	return odds;
}
...
int SlumberWhipOdds(struct BattleUnit* actor, struct BattleUnit* target){
	int odds = 30;
	if (UNIT_HAS_SKILL(&actor->unit,DOM,skill_323)){
		odds = 70;
	}
	if (UNIT_HAS_SKILL(&actor->unit,DOM,skill_322)){
		odds = 50;
	}
	return odds;
}
...
int ToxinWhipOdds(struct BattleUnit* actor, struct BattleUnit* target){
	int odds = 40;
	if (UNIT_HAS_SKILL(&actor->unit,DOM,skill_313)){
		odds = 80;
	}
	if (UNIT_HAS_SKILL(&actor->unit,DOM,skill_312)){
		odds = 60;
	}
	return odds;
}
